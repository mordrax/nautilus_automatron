...
type SourceMode = 'backtest' | 'catalog'

export const DashboardPage = () => {
  const [mode, setMode] = useState<SourceMode>('backtest')
  ...
  return (
    <div className="px-2 py-4">
      <Tabs value={mode} onValueChange={(v) => setMode(v as SourceMode)}>
        <TabsList>
          <TabsTrigger value="backtest">Backtest Runs</TabsTrigger>
          <TabsTrigger value="catalog">Instrument Data Catalog</TabsTrigger>
        </TabsList>
